...
Stick to the following project structure when writing code and creating new files and if there are new front-end developments, follow the relevant skills. 
